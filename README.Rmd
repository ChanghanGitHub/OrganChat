...
OrganChat reveals cross-organ communication for human multiple-disease systems -- the [files](Examples/HumanAtlas_Science_2022) include
(1) [Processing the original data](Examples/HumanAtlas_Science_2022/HumanAtlas_Science_2022_DataProcessing.Rmd)
