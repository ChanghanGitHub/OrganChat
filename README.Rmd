...
[Inferring, analyzing, and comparing the organ-organ communication (OOC) between different conditions using OrganChat.](`r paste0('file:///', file.path(find.package('OrganChat'), 'vignettes', 'Comparison_Analysis_Tutorial.html'))`)
